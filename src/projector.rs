...
mod test {
    ...
    fn get_value() {
        ...
        assert_eq!(proj.get_value("baz"), Some(&String::from("foo1")));
    }
    ...
    fn set_value() {
        ...
        proj.set_value(String::from("baz"), String::from("testing"));

        assert_eq!(proj.get_value("foo"), Some(&String::from("bar4")));
        assert_eq!(proj.get_value("baz"), Some(&String::from("testing")));
    }
